...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    text: 'Transitioning out of a high-density urban tower under strict 120-minute loading rules is demanding. The service team arrived with trained professionals, installed protection instantly and executed our complete project ahead of schedule. Punctuality Verified!',
  ...
  },
  {
    ...
    rating: 5,
    text: 'The team handled our complex project requirements down complex heritage stairway architecture. Their structural hoisting apparatus and white-glove caution were exceptional. Zero structural surface marks and internal acoustics maintained perfectly. Highly recommend their specialized service.',
  ...
  },
  {
    ...
    role: 'Tech Executive',
    rating: 5,
    text: 'The quoting process was 100% accurate. Zero ancillary fees or unannounced surcharges. Logistics-Coordination scheduled everything smoothly, and the Elite Crew crew supplied excellent service which simplified the entire process. A premium experience start to finish.',
  ...
  },
  {
    ...
    role: 'Recent Client',
    rating: 5,
    text: 'We needed reliable service. The team dispatched dedicated resources featuring real-time tracking. Our chronological progression from quotation to unpacking was exemplary. Arrived exactly when promised.',
