    ...
    <header className="sticky top-0 bg-zinc-900/60/95 backdrop-blur-md border-b border-neutral-200 dark:border-zinc-800 shadow-sm text-neutral-900 dark:text-white z-50 transition-all">
        ...
        <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            <span className="flex items-center gap-1.5 font-bold">
              <span className="relative flex h-2 w-2" aria-hidden="true">
                <span className="animate-ping motion-reduce:animate-none absolute inline-flex h-full w-full rounded-full bg-white dark:bg-neutral-950 opacity-75"></span>
                <span className="relative inline-flex rounded-full h-2 w-2 bg-white dark:bg-neutral-950"></span>
              </span>
          ...
          <div className="flex items-center gap-4 text-xs">
            <button 
              ...
              className="min-h-[44px] text-neutral-900 dark:text-white hover:text-zinc-200 underline underline-offset-2 flex items-center gap-1 font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 rounded-md px-1"
            >
              Request Free Condo COI <ArrowUpRight className="w-3.5 h-3.5" aria-hidden="true" />
            </button>
            <span className="opacity-50" aria-hidden="true">|</span>
            <a href={`tel:${BRAND.phoneRaw}`} className="min-h-[44px] flex items-center gap-1 text-neutral-900 dark:text-white hover:text-zinc-200 font-bold focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 rounded-md px-1">
              <Phone className="w-3.5 h-3.5 text-neutral-900 dark:text-white" aria-hidden="true" />
              {BRAND.phone}
            </a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5 flex items-center justify-between gap-4">
        ...
        >
          {BRAND.logoUrl ? (
            ...
            <>
              <div className="w-10 h-10 rounded-xl bg-primary-400 flex items-center justify-center text-neutral-900 dark:text-white font-black text-xl shadow-lg shadow-primary-500/20 group-hover:scale-105 transition-transform" aria-hidden="true">
                {BRAND.logoSymbol}
              </div>
              <div>
            ...
            return (
              <button
                ...
                className={`min-h-[44px] px-3.5 py-2 rounded-lg text-xs flex items-center gap-1.5 transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 ${
                  isActive
                    ? 'bg-primary-400 text-neutral-900 dark:text-white shadow-md shadow-primary-500/20 font-extrabold'
                    : item.highlight
                    ? 'text-primary-600 hover:bg-primary-50 font-bold'
                    : 'text-zinc-300 hover:text-black hover:bg-neutral-100 dark:bg-zinc-800 font-semibold'
                }`}
        ...
        <div className="hidden sm:flex items-center gap-3">
          <button
            ...
            className="group min-h-[44px] bg-white dark:bg-neutral-950 hover:bg-neutral-800 text-primary-400 px-4 py-2.5 rounded-full font-extrabold text-xs tracking-wider uppercase flex items-center gap-2 transition-all shadow-lg hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400"
          >
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden bg-white dark:bg-zinc-900/60 border-b border-l border-neutral-200 dark:border-zinc-800 shadow-2xl px-4 py-4 space-y-2 animate-in slide-in-from-top-2 text-neutral-900 dark:text-white">
            ...
            return (
              <button
                ...
                className={`w-full min-h-[44px] px-4 py-3 rounded-xl text-sm font-semibold flex items-center justify-between transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 ${
                  isActive
                    ? 'bg-primary-400 text-neutral-900 dark:text-white font-extrabold shadow-sm'
                    : 'text-zinc-300 hover:text-black hover:bg-neutral-100 dark:bg-zinc-800'
                }`}
                aria-current={isActive ? 'page' : undefined}
              >
                <div className="flex items-center gap-3">
                  <Icon className={`w-4 h-4 ${isActive ? 'text-neutral-900 dark:text-white' : 'text-primary-600'}`} aria-hidden="true" />
          ...
          <div className="pt-3 border-t border-neutral-200 dark:border-zinc-800 flex flex-col gap-2">
            <button
              type="button"
              onClick={() => {
                onOpenCOIModal();
              ...
              className="w-full min-h-[44px] py-3 px-4 rounded-xl bg-primary-50 border border-neutral-200 dark:border-zinc-800 text-neutral-900 dark:text-white text-xs font-bold text-center flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 hover:bg-primary-100"
            >
            ...
            <a
              ...
              className="w-full min-h-[44px] py-3 px-4 rounded-xl bg-white dark:bg-neutral-950 text-primary-400 text-xs font-extrabold uppercase text-center flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-400 hover:bg-neutral-50 dark:bg-neutral-900 shadow-lg"
            >
