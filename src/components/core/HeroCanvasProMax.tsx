...
export const HeroCanvasProMax: React.FC<HeroCanvasProMaxProps> = ({ variant = 'logistics-radar-grid' }) => {
  ...
  if (variant === 'logistics-radar-grid') {
    return (
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-neutral-950 text-emerald-400">
        ...
        <div className="absolute top-1/4 left-1/4 animate-bounce duration-1000 hidden md:flex items-center gap-2 bg-neutral-900/90 border border-emerald-500/50 px-3 py-1.5 rounded-full shadow-lg pointer-events-auto">
          <span className="w-2.5 h-2.5 rounded-full bg-emerald-400 animate-ping" />
          <MapPin className="w-3.5 h-3.5 text-emerald-400" />
          <span className="text-[11px] font-mono font-bold text-white uppercase">{GEO.regionName} Dispatch Node 01</span>
        </div>

        <div className="absolute bottom-1/3 right-1/4 animate-pulse hidden md:flex items-center gap-2 bg-neutral-900/90 border border-emerald-500/50 px-3 py-1.5 rounded-full shadow-lg pointer-events-auto">
        ...
        <div className="absolute top-1/3 right-1/6 hidden lg:flex items-center gap-2 bg-black/80 border border-neutral-700 p-3 rounded-2xl max-w-xs pointer-events-auto">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-gradient-to-b from-neutral-100 via-white to-neutral-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950">
        ...
        <div className="absolute top-12 left-6 w-56 h-80 rounded-t-[100px] rounded-b-3xl border-4 border-white dark:border-neutral-800 shadow-2xl overflow-hidden hidden xl:block pointer-events-auto transform -rotate-3 hover:rotate-0 transition-transform duration-500">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent flex items-end p-4">
            <span className="text-[11px] font-extrabold text-white uppercase tracking-wider">★ White-Glove Certified</span>
          </div>
        </div>
        ...
        <div className="absolute top-24 right-8 w-64 h-72 rounded-[40px] border-4 border-white dark:border-neutral-800 shadow-2xl overflow-hidden hidden xl:block pointer-events-auto transform rotate-2 hover:rotate-0 transition-transform duration-500">
          <img 
            ...
            className="w-full h-full object-cover"
          />
          <div className="absolute top-3 right-3 bg-zinc-900/60 text-black text-[10px] font-black px-2.5 py-1 rounded-full shadow">
            $2M COI Bonded
          </div>
          <div className="absolute bottom-3 left-3 bg-black/80 backdrop-blur-md text-primary-400 text-xs font-bold px-3 py-1.5 rounded-xl border border-neutral-700">
  ...
  if (variant === 'architectural-arch-split') {
    return (
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-neutral-950 text-white flex justify-between">
        ...
        <div className="w-1/2 h-full border-r border-neutral-800 relative hidden lg:block">
          ...
          <div className="absolute bottom-20 left-12 max-w-xs p-5 bg-neutral-900/90 border border-neutral-800 shadow-2xl rounded-2xl pointer-events-auto backdrop-blur-md">
        ...
        <div className="w-1/2 h-full relative hidden lg:flex items-center justify-center p-12">
          <div className="w-96 h-[85%] rounded-t-[200px] rounded-b-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative border-8 border-white dark:border-neutral-900 pointer-events-auto">
            <img 
              ...
              className="w-full h-full object-cover"
            />
            <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-black via-black/40 to-transparent p-6 text-white">
  ...
  if (variant === 'ambient-3d-glassmorphism') {
    return (
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-slate-950 text-white">
        ...
        <div className="absolute top-20 left-10 hidden xl:flex flex-col gap-2 p-5 rounded-3xl bg-zinc-900/60/10 dark:bg-zinc-900/60/5 backdrop-blur-2xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.5)] max-w-xs pointer-events-auto transform -rotate-3 hover:rotate-0 transition-all duration-300">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase bg-zinc-900/60/20 text-white px-2.5 py-0.5 rounded-full">Telemetry Active</span>
        ...
        <div className="absolute bottom-12 right-12 hidden xl:flex items-center gap-4 p-5 rounded-3xl bg-zinc-900/60/10 dark:bg-zinc-900/60/5 backdrop-blur-2xl border border-white/20 shadow-[0_8px_32px_rgba(0,0,0,0.5)] pointer-events-auto transform rotate-2 hover:rotate-0 transition-all duration-300">
          ...
          <div>
            ...
            <div className="text-sm font-black text-white">Condo COI Issued in {LEGAL.coiDeliverySLAShort}</div>
          </div>
        </div>
      </div>
    );
  ...
  if (variant === 'brutalist-diagonal-marquee') {
    return (
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-amber-300 dark:bg-neutral-900 flex flex-col justify-between opacity-20">
        ...
        <div className="w-[150%] bg-black text-white py-3 transform -rotate-6 -translate-x-12 flex whitespace-nowrap text-sm font-mono font-black tracking-widest overflow-hidden shadow-2xl">
  ...
  if (variant === 'social-proof-orbit') {
    return (
      <div className="absolute inset-0 pointer-events-none overflow-hidden bg-slate-900 text-white">
        ...
        <div className="absolute top-16 left-1/6 hidden md:flex items-center gap-3 bg-neutral-900/90 border border-neutral-700 p-3.5 rounded-2xl shadow-2xl pointer-events-auto transform -rotate-2 hover:rotate-0 transition-transform max-w-xs">
        ...
        <div className="absolute top-28 right-1/6 hidden md:flex items-center gap-3 bg-neutral-900/90 border border-neutral-700 p-3.5 rounded-2xl shadow-2xl pointer-events-auto transform rotate-3 hover:rotate-0 transition-transform max-w-xs">
        ...
        <div className="absolute bottom-12 left-1/4 hidden lg:flex items-center gap-3 bg-neutral-900/90 border border-neutral-700 p-3.5 rounded-2xl shadow-2xl pointer-events-auto transform -rotate-1 hover:rotate-0 transition-transform">
          <Award className="w-8 h-8 text-amber-400 shrink-0" />
          <div>
            <div className="text-[11px] font-bold text-white">Voted Top White-Glove Carrier 2026</div>
