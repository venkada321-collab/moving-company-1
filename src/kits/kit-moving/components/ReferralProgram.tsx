...
export const ReferralProgram: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-primary-50 via-white to-primary-50/50 py-16 px-4 text-neutral-900 dark:text-white border-y border-neutral-200 dark:border-zinc-800">
      <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-primary-400 via-primary-300 to-primary-400 text-black rounded-sm shadow-2xl p-8 md:p-12 shadow-2xl shadow-primary-500/20 border border-primary-400/50 text-center md:text-left mb-12">
          ...
          <h2 className="text-black font-black text-5xl md:text-6xl tracking-tight font-['Montserrat',sans-serif]">
            AWARD ${BRAND.referralGiveAmount}, <span className="text-neutral-900 dark:text-white">GET ${BRAND.referralGetAmount} PARTNER BONUS</span>
          </h2>
          <p className="mt-3 text-neutral-900 dark:text-white font-bold max-w-2xl md:mx-0 mx-auto text-lg">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start relative overflow-hidden">
          ...
          <div className="lg:col-span-7 bg-white dark:bg-neutral-50 dark:bg-zinc-900/60 border-2 border-primary-300 rounded-2xl p-6 shadow-lg text-neutral-900 dark:text-white space-y-6">
            <div className="space-y-1">
              <span className="text-xs font-bold text-primary-600 uppercase tracking-widest">
                STAGE 1: ESTABLISH YOUR EXECUTIVE ADVOCACY LINK
              </span>
              <h3 className="text-2xl font-black text-neutral-900 dark:text-white font-['Montserrat',sans-serif]">
            ...
            <form onSubmit={handleGenerate} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label htmlFor="referral-user-name" className="text-xs font-semibold text-neutral-600 dark:text-zinc-300">Advocate Name</label>
                  <input
                    ...
                    className="w-full bg-neutral-50 dark:bg-zinc-900/40 border border-neutral-300 text-neutral-900 dark:text-white font-mono p-3 rounded-xl focus:outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-400/30 min-h-[44px]"
                  />
                </div>

                <div className="space-y-1.5">
                  <label htmlFor="referral-user-email" className="text-xs font-semibold text-neutral-600 dark:text-zinc-300">Contact Email (for ${BRAND.referralGetAmount} Electronic Remittance)</label>
                  <input
            ...
            {submitted && (
              <div className="mt-6 bg-primary-50/50 border border-neutral-200 dark:border-zinc-800 rounded-2xl p-5 space-y-3 animate-in fade-in duration-300 motion-reduce:animate-none">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2">
                  <div className="w-full bg-neutral-50 dark:bg-zinc-900/40 border border-neutral-300 p-3 rounded-xl font-mono text-sm text-neutral-900 dark:text-white font-bold break-all min-h-[44px] flex items-center">
                    {shareableUrl}
                  </div>
                  <button
                    type="button"
          ...
          <div className="lg:col-span-5 bg-white dark:bg-neutral-50 dark:bg-zinc-900/60 rounded-2xl p-6 border border-neutral-200 dark:border-zinc-800 shadow-xl shadow-primary-900/5 text-neutral-900 dark:text-white hover:border-primary-400 transition-all space-y-6">
            <h4 className="text-lg font-bold text-neutral-900 dark:text-white font-['Montserrat',sans-serif] flex items-center gap-2">
              <DollarSign className="w-5 h-5 text-primary-500" aria-hidden="true" />
              Mechanics of the ${BRAND.referralGetAmount} Honorarium System
            </h4>

            <div className="space-y-4 text-sm text-neutral-600 dark:text-zinc-300">
              <div className="flex items-start gap-4">
                <div className="bg-neutral-100 dark:bg-black text-primary-400 font-black w-12 h-12 rounded-full flex items-center justify-center text-xl shadow-md shrink-0" aria-hidden="true">1</div>
                <div className="pt-1">
                  <div className="font-bold text-neutral-900 dark:text-white">Publish Your Token</div>
                  <div className="mt-1 text-xs">Send your custom code to friends, family, or {GEO.regionName} neighbors.</div>
                </div>
              </div>

              <div className="flex items-start gap-4">
                <div className="bg-neutral-100 dark:bg-black text-primary-400 font-black w-12 h-12 rounded-full flex items-center justify-center text-xl shadow-md shrink-0" aria-hidden="true">2</div>
                <div className="pt-1">
                  <div className="font-bold text-neutral-900 dark:text-white">Associate Saves ${BRAND.referralGiveAmount} Immediately</div>
              ...
              <div className="flex items-start gap-4">
                <div className="bg-neutral-100 dark:bg-black text-primary-400 font-black w-12 h-12 rounded-full flex items-center justify-center text-xl shadow-md shrink-0" aria-hidden="true">3</div>
                <div className="pt-1">
                  <div className="font-bold text-neutral-900 dark:text-white">You Acquire ${BRAND.referralGetAmount} Electronic Transfer</div>
