...
function fixDarkMode(file) {
  ...
  // Make sure to restore the primary buttons text that might have been changed inappropriately
  // e.g. text-white in a button should probably stay or be text-zinc-900 depending on primary color
  // Let's just do a blanket replace, the UI will be light mode now.
